...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        #maxQ = max(self.Q[state].values) #TypeError: 'builtin_function_or_method' object is not iterable
        qlist = []
    ...
    def createQ(self, state):
        ...
        if self.learning == True:
            if self.Q.has_key(state) == False:
                self.Q[state] = {}
                for i,j in enumerate(self.valid_actions):
                    self.Q[state][self.valid_actions[i]] = 0.0
        return
    ...
    def update(self):
        ...
        self.learn(state, action, reward)   # Q-learns
